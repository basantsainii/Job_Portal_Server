          ...
          <tr>
            <td style="padding: 20px;">
              ...
              <p style="font-size: 16px; line-height: 1.6;">
                Thank you {name}    for signing up with <strong>Find Employee Job Portal</strong>! To complete your registration, please verify your email address by clicking the button below.
              </p>
              <p style="text-align: center; margin: 20px 0;">
                <a href="{link}" style="background-color: green; color: #ffffff; text-decoration: none; padding: 8px 15px; border-radius: 5px; display: inline-block; font-size: 16px;">Verify Email</a>
              </p>
